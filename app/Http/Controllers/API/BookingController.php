...
class BookingController extends Controller
{
    public function getBookingList(Request $request){
        ...
        $booking = $booking->orderBy('date',$orderBy)->paginate($per_page);
    ...
    public function getBookingDetail(Request $request){
        ...
        $booking_data = Booking::with('customer','provider','service','bookingRating')->findorfail($id);
        ...
        if($data['status'] === 'hold'){
            if($bookingdata->start_at == null && $bookingdata->end_at == null){
                ...
                if($bookingdata->status == $data['status']){
                    ...
                    if($bookingdata->start_at != null && $bookingdata->end_at != null){
                        $new_diff = duration($data['start_at'] ,$data['end_at'] ,'in_minute');
