...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($user->hasRole('provider')) {
            $providerbooking    = Booking::where('provider_id',$user->id)->get()->pluck('id')->toArray(); 
            $revenuedata    = $revenuedata->whereIn('booking_id',$providerbooking);
            $total_revenue  = $total_revenue->whereIn('booking_id',$providerbooking);
        }
