            ...
            ->editColumn('status' , function ($provideraddress){
                return '<div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
                    <div class="custom-switch-inner">
                        <input type="checkbox" class="custom-control-input bg-success change_status" data-type="providertype_status" '.($provideraddress->status ? "checked" : "").' value="'.$provideraddress->id.'" id="'.$provideraddress->id.'" data-id="'.$provideraddress->id.'">
