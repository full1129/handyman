<template>
<div>
<breadcrumb-component  :sectionName="this.$route.meta.label"/>
        ...
        <div class="col-lg-6">
            <div class="contact-info">
                ...
                <div class="icon-box-wrapper">
                    ...
                    <div v-if="generalsetting.helpline_number" class="icon-content">
                        <p class="mb-0">Helpline Number</p>
                ...
                <div class="icon-box-wrapper">
                    ...
                    <div v-if="generalsetting.inquriy_email" class="icon-content">
                        <p class="mb-0">Business Inquries</p>
                        <h6 class="mb-0">{{generalsetting.inquriy_email}}</h6>                       
                    </div>
                </div>
                <div class="separator">               
                </div>
                <div class="social-box">
                    ...
                    <ul class="list-unstyled social_icon d-flex mb-0">
                        ...
                        <li>
                        <li>
                            <a :href="generalsetting.instagram_url" class="link-footer" target="_blank">
