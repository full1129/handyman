...
<div class="row">
    ...
    <div class="col-lg-6">
            ...
            <div class="col-sm-12">
                <select class="form-control select2js" name="time_zone" id="time_zone"
                    ...
                    @if(isset(\Auth::user()->time_zone))
                        <option value="{{ \Auth::user()->time_zone }}" selected="">{{ timeZoneList()[\Auth::user()->time_zone] }}</option>
                    @endif
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                {{ Form::text('facebook_url', null, ['class'=>"form-control" , 'placeholder'=>__('messages.facebook_url') ]) }}
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-sm-6 form-control-label">{{ __('messages.twitter_url') }}</label>
            <div class="col-sm-12">
                {{ Form::text('twitter_url', null, ['class'=>"form-control" , 'placeholder'=>__('messages.twitter_url') ]) }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                {{ Form::text('linkedin_url', null, ['class'=>"form-control" , 'placeholder'=> __('messages.linkedin_url') ]) }}
            </div>
        </div>
        <!-- <hr> -->
        <div class="form-group">
