                                ...
                                <ul class="nav flex-column nav-pills mb-3 nav-fill tabslink" id="tabs-text" role="tablist">
                                    ...
                                    @else
                                        @hasanyrole('admin|demo_admin')
                                            ...
                                            <li class="nav-item">
                                                <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=app-settings" data-target=".paste_here" class="nav-link {{$page=='app-settings'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('messages.app_settings') }}</a>
                                            </li>
                                        @endhasanyrole
                                    @endif
                                </ul>
