@php
    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use($url){
        ...
        $menu->add('<span>'.__('messages.booking').'</span>', ['class' => ''])
                ->prepend('<i class="ri-calendar-check-line"></i>')
                ->nickname('booking')
                ->data('permission', 'booking list')
                ->link->attr(["class" => ""])
                ->href('#bookings');
    
                $menu->booking->add('<span>'.__('messages.list_form_title',['form' => __('messages.booking')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'booking.index'])
                    ->data('permission', 'booking list')
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->link->attr(['class' => '']);

                /* $menu->booking->add('<span>'.__('messages.add_form_title',['form' => __('messages.booking')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'booking.create'])
                    ->data('permission', 'booking add')
                    ->link->attr(['class' => '']); */
        ...
        $menu->add('<span>'.__('messages.user').'</span>', ['class' => ''])
                ...
                $menu->user->add('<span>'.__('messages.list_form_title',['form' => __('messages.user')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'user.index'])
                    ->data('permission', 'user list')
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->link->attr(['class' => '']);
...
<div class="iq-sidebar sidebar-default">
    <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
        <a href="{{ route('home') }}" class="header-logo">
            ...
            <!-- <span>{{ settingSession('get')->site_name ?? "" }}</span> -->
        </a>
