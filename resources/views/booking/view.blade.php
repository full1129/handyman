                                        ...
                                        <div class="col-md-1 galary file-gallary-{{$bookingdata->id}}" data-gallery=".file-gallary-{{$bookingdata->id}}">
                                            @if($extention)
                                                <a id="attachment_files" href="{{ $image }}" class="list-group-item-action attachment-list" target="_blank">
                                                    <img src='{{ $image }}' class="rounded shadow-sm border" style="height:70px" />
                                                </a>
                                            @else
                                                <a id="attachment_files" class="video list-group-item-action attachment-list" href="{{ $image }}" target="_blank">
                                                    <img src="{{ asset('images/file.png') }}" class="rounded shadow-sm border" style="height:70px">
                                                </a>
                                            @endif
                                        </div>
                                        <div class="d-flex flex-column mx-3 col-md-4">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">( {{ optional($bookingdata->couponAdded)->code ?? '-' }}) {{ optional($bookingdata->coupon)->discount ?? '0' }} </td>
                                                    </tr>
                                                    <tr>
